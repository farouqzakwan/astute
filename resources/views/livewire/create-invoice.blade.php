<div>
    {{-- 
        <div class="w-full mt-8 bg-white dark:bg-gray-800 py-5 px-3 flex flex-row-reverse">
            <a 
                target="_blank"
                href="{{ route('dashboard.invoices.print') }}" 
                class="flex items-center justify-left px-4 py-2 mx-3 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
            ...
            <a 
                target="_blank"
                href="{{ route('dashboard.invoices.preview') }}" 
